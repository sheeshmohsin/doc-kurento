...
`GitHub <https://github.com/Kurento/kurento-tutorial-java/tree/release-5.1/kurento-crowddetector>`_.
...
`package.json <https://github.com/Kurento/kurento-tutorial-node/blob/release-5.1/kurento-crowddetector/package.json>`_
...
`bower.json <https://github.com/Kurento/kurento-tutorial-node/blob/release-5.1/kurento-crowddetector/static/bower.json>`_
